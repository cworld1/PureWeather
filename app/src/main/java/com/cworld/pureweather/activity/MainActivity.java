...
import com.cworld.pureweather.card.RadarCardView;
...
import com.cworld.pureweather.util.FullscreenHelper;
...
public class MainActivity extends BaseActivity {
    ...
    public final static String ACTION_OPENALERT = "com.cworld.pureweather.ACTION_OPENALERT";
    ...
    public void initViewLogic() {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            private final GithubUtils.GitHubRepo pureWeatherRepo = GithubUtils.getRepo("cworld0", "PureWeather");
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getGroupId() == R.id.settings_group) {
                    ...
                    } else if (itemId == R.id.menu_visit_project) {
                        CustomTabs.getInstance(MainActivity.this)
                                .launch(MainActivity.this, Uri.parse(pureWeatherRepo.getNewIssueUrl(null, null)));
    ...
    private void addAccessibilityLabelToNavMenuItems() {
        ((RecyclerView) navigationView.getChildAt(0)).addItemDecoration(new RecyclerView.ItemDecoration() {
            ...
            final String REPORT_A_BUG = getString(R.string.text_visit_project);
