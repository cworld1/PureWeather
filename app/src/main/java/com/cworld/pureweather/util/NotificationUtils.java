...
package com.cworld.pureweather.util;
...
import com.cworld.pureweather.activity.MainActivity;
...
import com.cworld.pureweather.view.CurrentWeatherRemoteViews;
...
public class NotificationUtils {
    ...
    private final static String ALERTS_GROUP_KEY = "com.cworld.pureweather.alerts_group";
    private final static String PERSISTENT_CHANNEL_ID = "persistentWeather";
    private final static String PERSISTENT_GROUP_KEY = "com.cworld.pureweather.persist_group";
    private final static String ERRORS_CHANNEL_ID = "notificationErrors";
    private final static String ERRORS_GROUP_KEY = "com.cworld.pureweather.errors_group";
